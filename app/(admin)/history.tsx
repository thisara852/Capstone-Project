...
import { View, Text, StyleSheet, FlatList, TouchableOpacity, ActivityIndicator, Alert, Modal, ScrollView, Image, Linking, KeyboardAvoidingView, Platform } from 'react-native';
      ...
      >
        ...
        >
          ...
          <View style={styles.actionRow}>
            <TouchableOpacity 
              style={[styles.actionBtn, { flex: 0.25, backgroundColor: '#FEF2F2', borderColor: '#FCA5A5', borderWidth: 1 }]}
            ...
            {item.verificationStatus === 'verified' ? (
              ...
              >
                ...
                <Text style={styles.rejectBtnText}>Remove Access</Text>
              </TouchableOpacity>
            ) : (
              <TouchableOpacity 
                    ...
                    <View style={styles.modalActions}>
                      {selectedOrganizer.verificationStatus !== 'rejected' && (
                        <TouchableOpacity 
                          ...
                          onPress={() => {
                            ...
                            handleOrganizerStatus(selectedOrganizer, 'rejected');
                          }}
                        >
                      ...
                      {selectedOrganizer.verificationStatus !== 'verified' && (
                        <TouchableOpacity 
                          ...
                          onPress={() => {
                            setSelectedOrganizer(null);
                            handleOrganizerStatus(selectedOrganizer, 'verified');
                          }}
                        >
...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 8, backgroundColor: '#F1F5F9', borderRadius: BorderRadius.full, borderWidth: 1, borderColor: '#CBD5E1' },
